...
|2 d|<span><span>$\[y = 4x + 6\]g$</span></span>|
|2 e|6 and 13.5|
|3 a|4|
|3 b|76, 428, and 15.25|
|3 c|<span><span>$y = 4x + 28$</span></span>|
|4 a|<span><span>$\[ - {1 \mathord{\left/ {\vphantom {1 9}} \right. \kern-\nulldelimiterspace} 9}\]$</span></span>|
...
|6 b|3|
|6 c|<span><span>${122} \mathord{\left/ {\vphantom {{122} 3}} \right. \kern-\nulldelimiterspace} 3$</span></span>|
|6 d|<span><span>$\left( {40,98} \right)$</span></span> would, <span>$\left( {50,158} \right)$</span> would not|
|7 a|<span><img class="image" width="32" height="22" src="9-Answers_9-8-11-PRINT-web-images/Eqn0117.eps" alt="Eqn0117.eps"></span>. When there is no fish in the aquarium, 45 snails can live in there.|
|7 b|<span><span>$\[\left( {20,0} \right)\]JzHJzxJz$</span></span>. When there is no snail in the aquarium, 20 fish can live in there.|
|8 a|\$2.95|
|8 b|\$2.62|
|8 c|At most 13 pages long|
|8 d|<span><span>$y = 11x + 75$</span></span> (in cents)|
|9 a|<span><span>$y = - 3x + 16$</span></span>|
|9 b|<span><span>$\left( {{{16} \mathord{\left/ {\vphantom {{16} 3}} \right. \kern-\nulldelimiterspace} 3},0} \right)$</span></span>|
|9 c|<span><span>$ - 20$</span></span>|
|9 d|<span><span>${13} \mathord{\left/ {\vphantom {{13} 3}} \right. \kern-\nulldelimiterspace} 3$</span></span>|
|10 a|<span><span>${ - 1} \mathord{\left/ {\vphantom {{ - 1} 3}} \right. \kern-\nulldelimiterspace} 3$</span></span>|
...
|12 b|<span><span>$\left( {{{252} \mathord{\left/ {\vphantom {{252} {13}}} \right. \kern-\nulldelimiterspace} {13}},0} \right)$</span></span> and <span>$\left( {0,{{252} \mathord{\left/ {\vphantom {{252} 5}} \right. \kern-\nulldelimiterspace} 5}} \right)$</span><br>|
|12 c|<span><span>$A_{20}$</span></span>|
|12 d|<span>$19$</span> <span>and</span> <span>$\[{{152} \mathord{\left/ {\vphantom {{152} {13}}} \right. \kern-\nulldelimiterspace} {13}}\]o@ z$</span>|
|12 e|True for 21.8|
|13 a|3.5 ft / min|
|13 b|560 ft|
...
|20 a|<span><span>$y = 80 + 8x$</span></span> and <span>$\[y = 108 + 4x\]韑}ӽHӽxӽ$</span> (in cents)<br>|
|20 b|<br><br><br>|
|20 c|7|
...
|21 c|Yes|
|22 a|2, 1, and 12|
|22 b|<span><span>$\[ - 4\]9$</span></span>, <span>$ - 17$</span>, <span>and</span> <span>$\[ - 3\]9$</span>|
|23 a|µ(x) = -5x+77|
...
|27|<span><span>${ - 1} \mathord{\left/ {\vphantom {{ - 1} 3}} \right. \kern-\nulldelimiterspace} 3$</span></span>|
|28|No|
|29|7|
|30|-----|
...
|36 a|<span><span>$\[y = 9x + 3\]آ؇$</span></span>|
|36 b|<span>Answers may vary.</span>|
|37 a|<span>11</span>|
|37 b|<span><span>$\[y = 2x - 11\]t$</span></span>|
|37 c|<span><span>$\[m = {{\left( {5 - c} \right)} \mathord{\left/ {\vphantom {{\left( {5 - c} \right)} {\left( {8 - c} \right)}}} \right. \kern-\nulldelimiterspace} {\left( {8 - c} \right)}}\]a$</span></span>|
|38 a|4.1|
|38 b|7.9|
|39|<span><span>$\left( {{5 \mathord{\left/ {\vphantom {5 {3,{{20} \mathord{\left/ {\vphantom {{20} 3}} \right. \kern-\nulldelimiterspace} 3}}}} \right. \kern-\nulldelimiterspace} {3,{{20} \mathord{\left/ {\vphantom {{20} 3}} \right. \kern-\nulldelimiterspace} 3}}}} \right)$</span></span>|
|40 a|68|
|40 b|630|
|40 c|25|
|41 a|\$0.65|
...
|42 e|<span><img class="image" width="61" height="19" src="9-Answers_9-8-11-PRINT-web-images/Eqn053.eps" alt="Eqn053.eps"></span>|
